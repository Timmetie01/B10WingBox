...
def shear_stress(wingbox, y):
        ...
        print(centroidal_moment_qb)
        print(centroidal_moment_Vy)
        ...
        #Below should sum back to total shear load:
        print(np.sum(shear_b * (current_wingbox.centroidal_panels[:,3] - current_wingbox.centroidal_panels[:,1]) / current_wingbox.panel_thickness))
