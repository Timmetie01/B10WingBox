...
testwingbox = data_import.idealizable_wingboxl(0.2, 0.6, [0.001, 0.01, 0.001, 0.015], 'partially_constant', stringercount=40, stringer_areas=5e-5, stringerspacing='constant_no_endpoints', panels_per_stringer=20, web_panel_count=50)
